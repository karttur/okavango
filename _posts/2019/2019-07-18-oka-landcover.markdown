...
The full resolution ecoregion classification is available as a GeoTiff image. The downloadable GeoTiff is projected to UTM34S (EPSG:32734), and available as a [zip file](../../docs/landcover/landcover_lt05_okaswamps_1994_pub.tif.zip). Note, that the data has been reprojected to the standard UTM projection using WGS84, not the Cape datum as in the original study.
