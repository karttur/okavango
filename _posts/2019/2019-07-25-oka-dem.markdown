...
The DEM for the larger Okavango region was created by combining the four regional DEMs and then smoothing the compositional DEM across areas with no pronounced faults (for details please see the [original article](http://doi.org/10.2113/1040243)). A few pronounced heights and troughs were added, and the elevation contour lines extracted. The final DEM, as a 500 m raster and as contour lines are listed and available for download in table 8.
